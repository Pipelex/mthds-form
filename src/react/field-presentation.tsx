 ...
 * result view - plus the file control, whose card hides a storage reference in
 * `app`, and threading a prop would have meant editing every field control and
 * both recursive containers.
 */
